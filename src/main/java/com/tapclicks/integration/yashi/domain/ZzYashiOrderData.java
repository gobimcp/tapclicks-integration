...
/**
 * The persistent class for the zz__yashi_order_data database table.
 * 
 */
@Entity
@Table(name="zz__yashi_order_data")
public class ZzYashiOrderData implements Serializable {
