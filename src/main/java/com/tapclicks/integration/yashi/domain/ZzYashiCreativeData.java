...
/**
 * The persistent class for the zz__yashi_creative_data database table.
 * 
 */
@Entity
@Table(name="zz__yashi_creative_data")
public class ZzYashiCreativeData implements Serializable {
	...
	private ZzYashiCreative zzYashiCreative;

	public ZzYashiCreativeData() {
	}
	...
	public ZzYashiCreative getZzYashiCreative() {
		return this.zzYashiCreative;
	}

	public void setZzYashiCreative(ZzYashiCreative zzYashiCreative) {
		this.zzYashiCreative = zzYashiCreative;
	}
